...
std::string AccessLogger::statusToString(LogStatus status) const {
    switch (status) {
        case LogStatus::OK: return "OK";
        case LogStatus::SYNTAX_ERROR: return "SYNTAX_ERROR";
        case LogStatus::EXECUTION_ERROR: return "EXECUTION_ERROR";
        case LogStatus::AUTH_ERROR: return "AUTH_ERROR";
        case LogStatus::IO_ERROR: return "IO_ERROR";
        case LogStatus::INTERNAL_ERROR: return "INTERNAL_ERROR";
