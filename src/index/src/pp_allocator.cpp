#include "../include/pp_allocator.h"
...
void *test_mem_resource::do_allocate_sm(size_t n) { return ::operator new(n); }

void test_mem_resource::do_deallocate_sm(void *p) { ::operator delete(p); }

bool test_mem_resource::do_is_equal(
